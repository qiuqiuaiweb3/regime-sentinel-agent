...
use regime_service::gemini_summary::{
    GeminiSummaryConfig, build_gemini_request, build_summary_prompt, parse_gemini_text,
    summary_record,
};
use serde_json::json;
...
fn gemini_summary_config_defaults_to_disabled_without_api_key() {
    let config = GeminiSummaryConfig::from_env_values(None, None, None, None, None, None)
...
#[test]
fn gemini_request_uses_generate_content_shape() {
...
#[test]
fn parse_gemini_text_reads_first_candidate_text() {
